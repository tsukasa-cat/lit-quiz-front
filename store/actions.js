    ...
    async login({ commit }, { team_name, password }) {
      ...
      try {
        ...
        let teams = [
            ...
            {"name": "p", "display_name": "O", password: "harami"},
            {"name": "q", "display_name": "P", password: "i-ji-"},
            {"name": "r", "display_name": "Q", password: "se-na-mu-n"},
            {"name": "s", "display_name": "R", password: "rikako"},
            {"name": "t", "display_name": "S", password: "apple"},
            {"name": "u", "display_name": "T", password: "gaito"},
            {"name": "v", "display_name": "U", password: "chu-toro"},
            {"name": "W", "display_name": "V", password: "hazuki"},
            {"name": "p", "display_name": "W", password: "rihoppe"},
        ];
